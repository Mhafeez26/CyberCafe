...
-- start_time  : reservation shuru hone ka waqt
-- end_time    : reservation khatam hone ka waqt
-- is range mein koi doosra customer us PC ko book nahi kar sakta
...
INSERT IGNORE INTO users (username, password, role_id) VALUES ('admin', 'admin', 1);
